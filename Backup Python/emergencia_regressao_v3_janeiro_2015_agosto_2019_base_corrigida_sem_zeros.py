...
start = time.time()
dfr2 = pd.read_excel('TB_IND_ASSIST_PA_0115_0819_V6.xlsx')
end = time.time()

print("Tempo de Execução: {:.2f} min".format((end - start)/60))
#Tempo de Execução: 18.33 min
...
Base Nova - Sem Zeros
Fit Time XGB: 104.2229455947876
Score Time XGB: 0.14336304664611815
Test Explained Variance XGB: 0.2005433695202205
STD Test Explained Variance XGB: 0.024927925013612136
Test Mean Absolute Error (MAE) XGB: -1.6823887795482677
STD Test Mean Absolute Error (MAE) XGB: 0.039775427760790016
Test Median Absolute Error XGB: -1.3658822774887085
STD Test Median Absolute Error XGB: 0.03848714607323053
Test Mean Squared Error (MSE) XGB: -4.657735286994887
STD Test Mean Squared Error (MSE) XGB: 0.21766326705866237
Test Root Mean Squared Error (RMSE) XGB: 2.1575811987578333
STD Test Root Mean Squared Error (RMSE) XGB: 0.05078048603151005
Test R2 Score XGB: 0.19973312952393213
STD Test R2 Score XGB: 0.02423043969189841
Test Max Error XGB: -7.617474114894867
STD Test Max Error XGB: 0.5857107257565214
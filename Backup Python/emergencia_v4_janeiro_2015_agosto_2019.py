...
start = time.time()
df = pd.read_excel('TB_IND_ASSIST_EME_0115_0819_V6.xlsx')
end = time.time()

print("Tempo de Execução: {:.2f} min".format((end - start)/60))
#Tempo de Execução: 20.09 min
...
#Pacientes Internados : 11.64 %
#Pacientes Não Internados : 88.36 %

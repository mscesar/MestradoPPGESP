...
start = time.time()
df1 = pd.read_excel('TB_IND_ASSIST_PA_0115_0819_V6.xlsx')
end = time.time()

print("Tempo de Execução: {:.2f} min".format((end - start)/60))
#Tempo de Execução: 18.29 min
...
X, Y - Base Nova
Fit Time LGBM: 613.0143776416778
Score Time LGBM: 39.08508546352387
Test Accuracy LGBM: 0.9542807392531605
STD Test Accuracy LGBM: 0.0022357310182165076
Test Balanced Accuracy LGBM: 0.8562560983635661
STD Test Balanced Accuracy LGBM: 0.005853829557664415
Test Area Under the Precision-Recall Curve LGBM: 0.8820483704935365
STD Test Area Under the Precision-Recall Curve LGBM: 0.007165936176639797
Test F1 LGBM: 0.7886731052120584
STD Test F1 LGBM: 0.010272335966572642
Test Precision LGBM: 0.8601922571820673
STD Test Precision LGBM: 0.013781219468150058
Test Recall LGBM: 0.728236434438077
STD Test Recall LGBM: 0.011170235689686283
Test ROC AUC LGBM: 0.977777764437534
STD Test ROC AUC LGBM: 0.0016922793461530666
Test MCC Score LGBM: 0.7666032534438398
STD Test MCC Score LGBM: 0.011572058666133339
Test Cohen Kappa Score LGBM: 0.763240513917544
STD Test Cohen Kappa Score LGBM: 0.011498517975607966

X, Y - Base Nova - Sem Zeros
Fit Time LGBM: 580.1717726230621
Score Time LGBM: 26.6210999250412
Test Accuracy LGBM: 0.957630502561773
STD Test Accuracy LGBM: 0.001163211593320161
Test Balanced Accuracy LGBM: 0.8584551921012917
STD Test Balanced Accuracy LGBM: 0.0037603394447373656
Test Area Under the Precision-Recall Curve LGBM: 0.8835558746266768
STD Test Area Under the Precision-Recall Curve LGBM: 0.005214940582332423
Test F1 LGBM: 0.7917418807273023
STD Test F1 LGBM: 0.005039927191095286
Test Precision LGBM: 0.86335952648358
STD Test Precision LGBM: 0.012436855028581285
Test Recall LGBM: 0.7312640988650536
STD Test Recall LGBM: 0.008322917479761709
Test ROC AUC LGBM: 0.9791057642455849
STD Test ROC AUC LGBM: 0.0015062740450090333
Test MCC Score LGBM: 0.7716805435053852
STD Test MCC Score LGBM: 0.0059065604351756324
Test Cohen Kappa Score LGBM: 0.7683401752392948
STD Test Cohen Kappa Score LGBM: 0.005656855837938882
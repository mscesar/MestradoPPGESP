...
resultado_combined_ftest_regressao2 = pd.ExcelWriter('V3/resultado_combined_ftest_regressao2.xlsx', engine = 'xlsxwriter')
# Convert the Dataframe to an XlsxWriter Excel Object.
Resultado.to_excel(resultado_combined_ftest_regressao2, sheet_name = 'Dados')
# Close the Pandas Excel Writer and Output the Excel File.
resultado_combined_ftest_regressao2.save()
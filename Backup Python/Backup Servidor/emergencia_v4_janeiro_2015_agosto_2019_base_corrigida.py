...
start = time.time()
df = pd.read_excel('TB_IND_ASSIST_PA_0115_0819_V6.xlsx')
end = time.time()

print("Tempo de Execução: {:.2f} min".format((end - start)/60))
#Tempo de Execução: 24.89 min

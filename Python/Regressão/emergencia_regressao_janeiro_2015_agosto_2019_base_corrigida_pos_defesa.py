...
start = time.time()
dfr = pd.read_excel('TB_IND_ASSIST_PA_0115_0819_V6.xlsx')
end = time.time()
...
Base Ajustada
Fit Time XGB: 84.53820536136627
Score Time XGB: 0.022232675552368165
...
Test R2 Score Custom XGB: 0.21809128540279224
STD Test R2 Score Custom XGB: 0.02241173698424469

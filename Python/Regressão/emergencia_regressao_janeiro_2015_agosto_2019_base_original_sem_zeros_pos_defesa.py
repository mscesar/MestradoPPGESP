...
start = time.time()
dfr2 = pd.read_excel('TB_IND_ASSIST_EME_0115_0819_V6.xlsx')
end = time.time()

print("Tempo de Execução: {:.2f} min".format((end - start)/60))
#Tempo de Execução: 10.33 min

dfr = dfr2.loc[(dfr2['TEMPO_PERM_INT_POSTERIOR'] != 0)].copy()
...
Base Original Sem Zeros
Fit Time XGB: 76.82782201766967
Score Time XGB: 0.01954784393310547
Test Explained Variance XGB: 0.19721400832928054
STD Test Explained Variance XGB: 0.023767199986252766
Test Mean Absolute Error (MAE) XGB: -1.6782214449558517
STD Test Mean Absolute Error (MAE) XGB: 0.04096403609207149
Test Median Absolute Error XGB: -1.3636256098747253
STD Test Median Absolute Error XGB: 0.06117317778637384
Test Mean Squared Error (MSE) XGB: -4.671365926713093
STD Test Mean Squared Error (MSE) XGB: 0.2132132745849167
Test Root Mean Squared Error (RMSE) XGB: 2.160768700836652
STD Test Root Mean Squared Error (RMSE) XGB: 0.0494423724934599
Test R2 Score XGB: 0.19616579576927826
STD Test R2 Score XGB: 0.023525096334543888
Test R2 Score Custom XGB: 0.19814613434380618
STD Test R2 Score Custom XGB: 0.02285485511681186
Test Max Error XGB: -7.54709403514862
STD Test Max Error XGB: 0.4734532634541201

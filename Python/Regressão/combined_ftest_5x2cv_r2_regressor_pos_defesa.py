...
Tempo de Execução: Tempo de Execução: 438.07 min      
...
resultado_combined_ftest_regressao = pd.ExcelWriter('V5/resultado_combined_ftest_r2_score_regressao.xlsx', engine = 'xlsxwriter')

...
#Função Customizada para o Cálculo do R² Score
...
corr_matrix_pearson_reg_order = corr_matrix_pearson_reg['TEMPO_PERM_INT_POSTERIOR'].sort_values(ascending = False)

k_reg = 20

corr_matrix_pearson_reg.nlargest(k_reg, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR']

corr_matrix_pearson_reg.nsmallest(k_reg, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR']

# Create a Pandas Excel Writer Using XlsxWriter as the Engine.
corr_matrix_pearson_reg_excel = pd.ExcelWriter('V3/corr_matrix_pearson_reg_excel.xlsx', engine = 'xlsxwriter')
# Convert the Dataframe to an XlsxWriter Excel Object.
corr_matrix_pearson_reg_order.to_excel(corr_matrix_pearson_reg_excel, sheet_name = 'Dados')
# Close the Pandas Excel Writer and Output the Excel File.
corr_matrix_pearson_reg_excel.save()
...
#Gráfico da Matriz de Pearson com 20-
cols_reg = corr_matrix_pearson_reg.nlargest(1, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR'].index
cols_reg_1 = corr_matrix_pearson_reg.nsmallest(k_reg, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR'].index 
cols_reg = cols_reg.append(cols_reg_1)
cm_reg = np.corrcoef(df_reg[cols_reg].values.T)
sns.set(font_scale = 1.2)
plt.figure(figsize = (10, 10))
hm_reg = sns.heatmap(cm_reg, cbar = True, annot = True, square = True, fmt = '.2f', annot_kws = {'size': 10}, yticklabels = cols_reg.values, xticklabels = cols_reg.values)
...
corr_matrix_pearson_reg_new = df_reg[corr_matrix_pearson_reg['TEMPO_PERM_INT_POSTERIOR'].nlargest(k_reg).index].corr('pearson')

sns.set(font_scale = 1.2)
plt.figure(figsize = (12, 12))
hm_reg = sns.heatmap(corr_matrix_pearson_reg_new, cbar = True, annot = True, square = True, fmt = '.2f', annot_kws = {'size': 14}, yticklabels = cols_reg.values, xticklabels = cols_reg.values)
plt.show()

#DataFrame com 20-
k_reg = 14

corr_matrix_pearson_reg_order_2 = pd.DataFrame(corr_matrix_pearson_reg_order)
cols_reg = corr_matrix_pearson_reg.nlargest(1, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR'].index
cols_reg_1 = corr_matrix_pearson_reg_order_2.nsmallest(k_reg, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR'].sort_values(ascending = False).index 
cols_reg = cols_reg.append(cols_reg_1)

corr_matrix_pearson_reg_new_menos = df_reg[cols_reg].corr('pearson')

sns.set(font_scale = 1.2)
plt.figure(figsize = (12, 12))
hm_reg = sns.heatmap(corr_matrix_pearson_reg_new_menos, cbar = True, annot = True, square = True, fmt = '.2f', annot_kws = {'size': 14}, yticklabels = cols_reg.values, xticklabels = cols_reg.values)
plt.show()
...
corr_matrix_spearman_reg_order = corr_matrix_spearman_reg['TEMPO_PERM_INT_POSTERIOR'].sort_values(ascending = False)

k_reg = 20

corr_matrix_spearman_reg.nlargest(k_reg, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR']

corr_matrix_spearman_reg.nsmallest(k_reg, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR']

# Create a Pandas Excel Writer Using XlsxWriter as the Engine.
corr_matrix_spearman_reg_excel = pd.ExcelWriter('V3/corr_matrix_spearman_reg_excel.xlsx', engine = 'xlsxwriter')
# Convert the Dataframe to an XlsxWriter Excel Object.
corr_matrix_spearman_reg_order.to_excel(corr_matrix_spearman_reg_excel, sheet_name = 'Dados')
# Close the Pandas Excel Writer and Output the Excel File.
corr_matrix_spearman_reg_excel.save()
...
corr_matrix_spearman_reg_new = df_reg[corr_matrix_spearman_reg['TEMPO_PERM_INT_POSTERIOR'].nlargest(k_reg).index].corr('spearman')
cols_reg = corr_matrix_spearman_reg_new.index

sns.set(font_scale = 1.2)
plt.figure(figsize = (12, 12))
hm_reg = sns.heatmap(corr_matrix_spearman_reg_new, cbar = True, annot = True, square = True, fmt = '.2f', annot_kws = {'size': 14}, yticklabels = cols_reg.values, xticklabels = cols_reg.values)
plt.show()

#DataFrame com 20-
k_reg = 14

corr_matrix_spearman_reg_order_2 = pd.DataFrame(corr_matrix_spearman_reg_order)
cols_reg = corr_matrix_spearman_reg.nlargest(1, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR'].index
cols_reg_1 = corr_matrix_spearman_reg_order_2.nsmallest(k_reg, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR'].sort_values(ascending = False).index 
cols_reg = cols_reg.append(cols_reg_1)

corr_matrix_spearman_reg_new_menos = df_reg[cols_reg].corr('spearman')

sns.set(font_scale = 1.2)
plt.figure(figsize = (12, 12))
hm_reg = sns.heatmap(corr_matrix_spearman_reg_new_menos, cbar = True, annot = True, square = True, fmt = '.2f', annot_kws = {'size': 14}, yticklabels = cols_reg.values, xticklabels = cols_reg.values)
plt.show()
...
corr_matrix_kendall_reg_order = corr_matrix_kendall_reg['TEMPO_PERM_INT_POSTERIOR'].sort_values(ascending = False)

k_reg = 20

corr_matrix_kendall_reg.nlargest(k_reg, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR']

corr_matrix_kendall_reg.nsmallest(k_reg, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR']

# Create a Pandas Excel Writer Using XlsxWriter as the Engine.
corr_matrix_kendall_reg_excel = pd.ExcelWriter('V3/corr_matrix_kendall_reg_excel.xlsx', engine = 'xlsxwriter')
# Convert the Dataframe to an XlsxWriter Excel Object.
corr_matrix_kendall_reg_order.to_excel(corr_matrix_kendall_reg_excel, sheet_name = 'Dados')
# Close the Pandas Excel Writer and Output the Excel File.
corr_matrix_kendall_reg_excel.save()
...
corr_matrix_kendall_reg_new = df_reg[corr_matrix_kendall_reg['TEMPO_PERM_INT_POSTERIOR'].nlargest(k_reg).index].corr('kendall')
cols_reg = corr_matrix_kendall_reg_new.index

sns.set(font_scale = 1.2)
plt.figure(figsize = (12, 12))
hm_reg = sns.heatmap(corr_matrix_kendall_reg_new, cbar = True, annot = True, square = True, fmt = '.2f', annot_kws = {'size': 14}, yticklabels = cols_reg.values, xticklabels = cols_reg.values)
plt.show()

#DataFrame com 20-
k_reg = 14

corr_matrix_kendall_reg_order_2 = pd.DataFrame(corr_matrix_kendall_reg_order)
cols_reg = corr_matrix_kendall_reg.nlargest(1, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR'].index
cols_reg_1 = corr_matrix_kendall_reg_order_2.nsmallest(k_reg, 'TEMPO_PERM_INT_POSTERIOR')['TEMPO_PERM_INT_POSTERIOR'].sort_values(ascending = False).index 
cols_reg = cols_reg.append(cols_reg_1)

corr_matrix_kendall_reg_new_menos = df_reg[cols_reg].corr('kendall')

sns.set(font_scale = 1.2)
plt.figure(figsize = (12, 12))
hm_reg = sns.heatmap(corr_matrix_kendall_reg_new_menos, cbar = True, annot = True, square = True, fmt = '.2f', annot_kws = {'size': 14}, yticklabels = cols_reg.values, xticklabels = cols_reg.values)
plt.show()
...
corr_matrix_pearson_reg_new_menos

# Generate a mask for the upper triangle
mask = np.zeros_like(corr_matrix_pearson_reg_new_menos, dtype = np.bool)
mask[np.triu_indices_from(mask)] = True
# Set up the matplotlib figure
f, ax = plt.subplots(figsize = (11, 9))
# Generate a custom diverging colormap
cmap = sns.diverging_palette(220, 10, as_cmap = True)
# Draw the heatmap with the mask and correct aspect ratio
sns.heatmap(corr_matrix_pearson_reg_new_menos, mask = mask, cmap = cmap, vmax = .3, center = 0,
            square = True, linewidths = .5, cbar_kws = {"shrink": .5})
...
plt.figure(figsize = (12,12))
sns.heatmap(corr_matrix_pearson_reg_new_menos, vmax = 1, square = True, annot = True, cmap = 'viridis')
...
corr_matrix_spearman_reg_new_menos

# Generate a mask for the upper triangle
mask = np.zeros_like(corr_matrix_spearman_reg_new_menos, dtype = np.bool)
mask[np.triu_indices_from(mask)] = True
# Set up the matplotlib figure
f, ax = plt.subplots(figsize = (11, 9))
# Generate a custom diverging colormap
cmap = sns.diverging_palette(220, 10, as_cmap = True)
# Draw the heatmap with the mask and correct aspect ratio
sns.heatmap(corr_matrix_spearman_reg_new_menos, mask = mask, cmap = cmap, vmax = .3, center = 0,
            square = True, linewidths = .5, cbar_kws = {"shrink": .5})
...
corr_matrix_kendall_reg_new_menos

# Generate a mask for the upper triangle
mask = np.zeros_like(corr_matrix_kendall_reg_new_menos, dtype = np.bool)
mask[np.triu_indices_from(mask)] = True
# Set up the matplotlib figure
f, ax = plt.subplots(figsize = (11, 9))
# Generate a custom diverging colormap
cmap = sns.diverging_palette(220, 10, as_cmap = True)
# Draw the heatmap with the mask and correct aspect ratio
sns.heatmap(corr_matrix_kendall_reg_new_menos, mask = mask, cmap = cmap, vmax = .3, center = 0,
            square = True, linewidths = .5, cbar_kws = {"shrink": .5})
...
print("Tempo de Execução: {:.2f} min".format((end - start)/60))
print(kf_cross_val_reg)
#Tempo de Execução: 266.46 min

# Create a Pandas Excel Writer Using XlsxWriter as the Engine.
cross_val_score_regressor = pd.ExcelWriter('V3/cross_val_score_regressor_r2_score_X_reg_Y_reg_kfold.xlsx', engine = 'xlsxwriter')
# Convert the Dataframe to an XlsxWriter Excel Object.
kf_cross_val_reg.to_excel(cross_val_score_regressor, sheet_name = 'Dados')
# Close the Pandas Excel Writer and Output the Excel File.
cross_val_score_regressor.save()
...
print("Tempo de Execução: {:.2f} min".format((end - start)/60))
print(kf_cross_val_reg)
#Tempo de Execução: 312.92 min

# Create a Pandas Excel Writer Using XlsxWriter as the Engine.
cross_val_score_regressor = pd.ExcelWriter('V3/cross_val_score_regressor_r2_score_X_reg_Y_reg_kfold_shuffle.xlsx', engine = 'xlsxwriter')
# Convert the Dataframe to an XlsxWriter Excel Object.
kf_cross_val_reg.to_excel(cross_val_score_regressor, sheet_name = 'Dados')
# Close the Pandas Excel Writer and Output the Excel File.
cross_val_score_regressor.save()
...
axis = sns.barplot(kf_cross_val_reg['Name'], kf_cross_val_reg['R² Score'])
axis.set(xlabel = 'Regressor', ylabel = 'R² Score')
...
print("Tempo de Execução: {:.2f} min".format((end - start)/60))
print(kf_cross_val_reg)
#Tempo de Execução: 670.79 min

# Create a Pandas Excel Writer Using XlsxWriter as the Engine.
cross_val_score_regressor = pd.ExcelWriter('V3/cross_val_score_regressor_r2_score_shuffle_X_reg_Y_reg.xlsx', engine = 'xlsxwriter')
# Convert the Dataframe to an XlsxWriter Excel Object.
kf_cross_val_reg.to_excel(cross_val_score_regressor, sheet_name = 'Dados')
# Close the Pandas Excel Writer and Output the Excel File.
cross_val_score_regressor.save()
...
#TESTE07: Treino e Teste dos Modelos com CrossValScore + 10 StratifiedKFold(shuffle = False) - X_reg, Y_reg
...
print("Tempo de Execução: {:.2f} min".format((end - start)/60))
print(kf_cross_val_reg)
#Tempo de Execução: 269.81 min

# Create a Pandas Excel Writer Using XlsxWriter as the Engine.
cross_val_score_regressor = pd.ExcelWriter('V3/cross_val_score_regressor_r2_score_X_reg_Y_reg_stratifiedkfold.xlsx', engine = 'xlsxwriter')
# Convert the Dataframe to an XlsxWriter Excel Object.
kf_cross_val_reg.to_excel(cross_val_score_regressor, sheet_name = 'Dados')
# Close the Pandas Excel Writer and Output the Excel File.
cross_val_score_regressor.save()

#TESTE08: Treino e Teste dos Modelos com CrossValScore + 10 StratifiedKFold(shuffle = True) - X_reg, Y_reg
...
print("Tempo de Execução: {:.2f} min".format((end - start)/60))
print(kf_cross_val_reg)
#Tempo de Execução: 272.56 min

# Create a Pandas Excel Writer Using XlsxWriter as the Engine.
cross_val_score_regressor = pd.ExcelWriter('V3/cross_val_score_regressor_r2_score_X_reg_Y_reg_stratifiedkfold_shuffle.xlsx', engine = 'xlsxwriter')
# Convert the Dataframe to an XlsxWriter Excel Object.
kf_cross_val_reg.to_excel(cross_val_score_regressor, sheet_name = 'Dados')
# Close the Pandas Excel Writer and Output the Excel File.
cross_val_score_regressor.save()
...
print("Tempo de Execução: {:.2f} min".format((end - start)/60))   
print(kf_cross_validate_reg)
#Tempo de Execução: 113.30 min

# Create a Pandas Excel Writer Using XlsxWriter as the Engine.
cross_validate_regressor = pd.ExcelWriter('V3/cross_validate_regressor_X_reg_Y_reg_stratifiedkfold2.xlsx', engine = 'xlsxwriter')
# Convert the Dataframe to an XlsxWriter Excel Object.
kf_cross_validate_reg.to_excel(cross_validate_regressor, sheet_name = 'Dados')
# Close the Pandas Excel Writer and Output the Excel File.
cross_validate_regressor.save()
...
print("Tempo de Execução: {:.2f} min".format((end - start)/60))   
print(kf_cross_validate_reg)
#Tempo de Execução: 113.15 min

# Create a Pandas Excel Writer Using XlsxWriter as the Engine.
cross_validate_regressor = pd.ExcelWriter('V3/cross_validate_regressor_X_reg_Y_reg_stratifiedkfold_shuffle2.xlsx', engine = 'xlsxwriter')
# Convert the Dataframe to an XlsxWriter Excel Object.
kf_cross_validate_reg.to_excel(cross_validate_regressor, sheet_name = 'Dados')
# Close the Pandas Excel Writer and Output the Excel File.
cross_validate_regressor.save()
...
Y_pred_train_reg = regressor_linear.predict(X_train_reg)

Y_pred_test_reg = regressor_linear.predict(X_test_reg)

regressor_linear.score(X_test_reg, Y_test_reg)
-2.5245017611539578e+23
...
mtrc_evs_linear = explained_variance_score(Y_test_reg, Y_pred_test_reg)
mtrc_mae_linear = mean_absolute_error(Y_test_reg, Y_pred_test_reg)
mtrc_mdae_linear = median_absolute_error(Y_test_reg, Y_pred_test_reg)
mtrc_mse_linear = mean_squared_error(Y_test_reg, Y_pred_test_reg)
mtrc_rmse_linear = np.sqrt(mean_squared_error(Y_test_reg, Y_pred_test_reg))
mtrc_r2_linear = r2_score(Y_test_reg, Y_pred_test_reg)
mtrc_max_error_linear = max_error(Y_test_reg, Y_pred_test_reg)

print('Explained Variance Score: {:.4f}'.format(mtrc_evs_linear))
print('Mean Absolute Error: {:.4f}'.format(mtrc_mae_linear)) 
print('Median Absolute Error: {:.4f}'.format(mtrc_mdae_linear)) 
print('Mean Squared Error: {:.4f}'.format(mtrc_mse_linear))
print('Root Mean Squared Error: {:.4f}'.format(mtrc_rmse_linear))
print('R² Score: {:.4f}'.format(mtrc_r2_linear))
print('Max Error: {:.4f}'.format(mtrc_max_error_linear))

coefficient_of_determination(Y_test_reg, Y_pred_test_reg)

coefficient_of_determination_by_correlation(Y_test_reg, Y_pred_test_reg)

coefficient_of_determination_r2(Y_test_reg, Y_pred_test_reg)

custom_r2(regressor_linear, X_test_reg, Y_test_reg)
...
Explained Variance Score: 0.1872453613066041
Mean Absolute Error: 1.7665356104190533
Median Absolute Error: 1.4279613494873047
Mean Squared Error: 5.1503821679000472
Root Mean Squared Error: 2.2694453436688109
R² Score: 0.1871528618834262
R² Score Custom: 0.1872487264823724
Max Error: 8.2134203910827637
...
Root Mean Squared Error: 2.2409917207036285
R² Score: 0.2074075530232811
R² Score Custom: 0.2078563512284686
Max Error: 8.6376013755798340
...
Explained Variance Score: 0.2094882991571071
Mean Absolute Error: 1.7203359037108674
Median Absolute Error: 1.3627285957336426
Mean Squared Error: 5.0155191461318234
Root Mean Squared Error: 2.2395354755242933
R² Score: 0.2084373059709510
R² Score Custom: 0.2094973063092389
Max Error: 8.7341184616088867
...
Explained Variance Score: 0.2072308765472317
Mean Absolute Error: 1.7211800750660944
Median Absolute Error: 1.3563890457153320
Mean Squared Error: 5.0295707740408666
Root Mean Squared Error: 2.2426704559611221
R² Score: 0.2062196403377226
R² Score Custom: 0.2072712012000580
Max Error: 8.3925604820251465
...
Tempo de Execução: 0.90 min

#TMP 10 Dias de Corte
Explained Variance Score: 0.2003695749857052
Mean Absolute Error: 1.7303395845480924
Median Absolute Error: 1.3723959922790527
Mean Squared Error: 5.0686229326498475
Root Mean Squared Error: 2.2513602405323425
R² Score: 0.2000563238443511
R² Score Custom: 0.2009036738865162
Max Error: 8.7897489070892334
...
R² Score Custom: 0.2027303027751879
Max Error: 8.6951642036437988

#11º Teste

regressor_xgb = XGBRegressor( n_estimators = 550, 
                              min_child_weight = 30, 
                              max_depth = 375, 
                              learning_rate = 0.01, 
                              n_jobs = 6 )

Tempo de Execução: 1.20 min
...
R² Score Custom: 0.2038039085957104
...
mtrc_r2_custom_xgb = coefficient_of_determination_by_correlation(Y_test_reg, Y_pred_test_reg_xgb)
...
#print('R² Score Custom: {:.4f}'.format(mtrc_r2_custom_xgb))
#print('Max Error: {:.4f}'.format(mtrc_max_error_xgb))

#coefficient_of_determination(Y_test_reg, Y_pred_test_reg_xgb)
#coefficient_of_determination_by_correlation(Y_test_reg, Y_pred_test_reg_xgb)
#custom_r2_by_correlation(regressor_xgb, X_test_reg, Y_test_reg)
...
param_range_vc = [100, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800, 850, 900, 950, 1000]
...
#CrossValScore - 10 KFolds - RMSE - X_train_reg, Y_train_reg
...
#CrossValScore - 10 KFolds - RMSE - X_reg, Y_reg
...
start = time.time()
scores_reg_xgb = cross_val_score(regressor_xgb, X_reg, Y_reg, cv = k_fold_reg, scoring = metric_reg)
scores_reg_xgb = np.sqrt(-scores_reg_xgb) 
end = time.time()
print("Tempo de Execução: {:.2f} min".format((end - start)/60))

#Tempo de Execução: 11.50 min

display_scores(scores_reg_xgb)

Scores: [2.19612335 2.31298531 2.20050955 2.28317021 2.17706338 2.16214372
 2.22102476 2.19146334 2.1764562  2.31140496]
Mean: 2.2232344767923378
Standard Deviation: 0.054533770232076104

#CrossValScore - 10 KFolds - R2 - X_train_reg, Y_train_reg
...
Scores: [0.16916837 0.20737076 0.20530195 0.20994398 0.16773229 0.29892534
 0.20450221 0.22889901 0.16480425 0.22503095]
Mean: 0.20816791158474768
Standard Deviation: 0.03743381242050885

#CrossValScore - 10 KFolds - R2 - X_reg, Y_reg
...
Scores: [0.22887654 0.18500264 0.2191389  0.24636188 0.19624311 0.20610595
 0.22856617 0.21788943 0.20637857 0.19798064]
Mean: 0.21325438273797054
Standard Deviation: 0.017464045136680297
...
metricas_cross_validate_reg = {'explained_variance': 'explained_variance', 
                               ...
                               'r2': 'r2',
                               'r2_custom': custom_r2_by_correlation,
                               'max_error': 'max_error'}
...
cv_test_r2_custom_reg_xgb = result_reg_xgb_cross_validate['test_r2_custom'].mean()
print('Test R2 Score Custom XGB: ' + str(cv_test_r2_custom_reg_xgb))

cv_test_r2_custom_std_reg_xgb = result_reg_xgb_cross_validate['test_r2_custom'].std()
print('STD Test R2 Score Custom XGB: ' + str(cv_test_r2_custom_std_reg_xgb))
...
Fit Time XGB: 43.68908784389496
Score Time XGB: 0.015446686744689941
Test Explained Variance XGB: 0.2065360459863625
STD Test Explained Variance XGB: 0.03669193775295775
Test Mean Absolute Error (MAE) XGB: -1.7253060775605538
STD Test Mean Absolute Error (MAE) XGB: 0.04996861573085539
...
Test R2 Score XGB: 0.2039081671406883
STD Test R2 Score XGB: 0.036070096374850764
Test R2 Score Custom XGB: 0.20816791158474768
STD Test R2 Score Custom XGB: 0.03743381242050885
Test Max Error XGB: -7.491297709941864
STD Test Max Error XGB: 0.48094008810212063
...
Fit Time XGB: 67.93454880714417
Score Time XGB: 0.019449853897094728
Test Explained Variance XGB: 0.2126177979861744
STD Test Explained Variance XGB: 0.01778529138550612
Test Mean Absolute Error (MAE) XGB: -1.7151600706402
STD Test Mean Absolute Error (MAE) XGB: 0.04632818807955341
Test Median Absolute Error XGB: -1.3699535727500916
STD Test Median Absolute Error XGB: 0.04096752353557674
Test Mean Squared Error (MSE) XGB: -4.945745470893825
STD Test Mean Squared Error (MSE) XGB: 0.24456350704184007
Test Root Mean Squared Error (RMSE) XGB: 2.2232344767923378
STD Test Root Mean Squared Error (RMSE) XGB: 0.054533770232076104
Test R2 Score XGB: 0.21157475440990564
STD Test R2 Score XGB: 0.01725101415199404
Test R2 Score Custom XGB: 0.21325438273797054
STD Test R2 Score Custom XGB: 0.017464045136680297
Test Max Error XGB: -7.780283415317536
STD Test Max Error XGB: 0.5615677458177719

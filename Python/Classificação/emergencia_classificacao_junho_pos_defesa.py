...
X_junho_19_list_array = np.array(X_junho_19_list)
...
mtrc_roc_auc_score_lgbm = roc_auc_score(Y_junho_19, Y_junho_19_pred_lgbm)
...
mtrc_average_precision_score_lgbm = average_precision_score(Y_junho_19, Y_junho_19_pred_lgbm)
...
Area Under the Receiver Operating Characteristic Curve (ROC AUC) : 0.7853704012912562
Area Under the Precision-Recall Curve : 0.5288139796162076
...
dados <- read.csv("D:/Dropbox/MauricioPessoal/Pós-Graduação/PPGESP/Projeto Final/Estudo Python/Bases Cárdio Pulmonar/V3/30-TESTES-REGRESSAO-CSV.csv")
...
dados <- read.csv("C:/Users/Mauricio/Dropbox/MauricioPessoal/Pós-Graduação/PPGESP/Projeto Final/Estudo Python/Bases Cárdio Pulmonar/V3/30-TESTES-REGRESSAO-XGB-CSV.csv")
